...
layers_ordered = [
    ...
    { 'name': 'rpoD_decomposed_spots', 'type': 'spots',
     'properties': {'blending': 'translucent_no_depth', 'visible': False, 'out_of_slice_display': True, 'symbol': 'disc',
                    'size': 10, 'border_width': 0.1, 'border_color': 'magenta', 'face_color': 'transparent',
                    'opacity': 1}},
    ...
    { 'name': 'rnlAB_decomposed_spots', 'type': 'spots',
      'properties': {'blending': 'translucent_no_depth', 'visible': False, 'out_of_slice_display': True, 'symbol': 'disc',
                    'size': 10, 'border_width': 0.1, 'border_color': 'cyan', 'face_color': 'transparent',
                    'opacity': 1}},
    ...
    {'name': 'hipBA_decomposed_spots', 'type': 'spots',
     'properties': {'blending': 'translucent_no_depth', 'visible': False, 'out_of_slice_display': True, 'symbol': 'disc',
                    'size': 10, 'border_width': 0.1, 'border_color': 'yellow', 'face_color': 'transparent',
                    'opacity': 1}},
